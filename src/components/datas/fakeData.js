...
export const newsinfo = [
  {
    title:
      "Menuju One Stop Service Layanan Kanker: RSPAW Siap Melayani Kemoterapi",
    description: `<p>"Senin (5/6/2023) tepat mulai hari ini RSPAW siap melayani kemoterapi dalam upaya menuju “One Stop Service Layanan Kanker”. <strong>Layanan baru ini disiapkan berjumlah 10 bed dan didukung oleh tim yang terdiri dari dua dokter</strong> konsultan onkologi yaitu dari dokter spesialis bedah onkologi dr Puguh Sihwidijono M.Si,Med,Sp.B.,Subsp.Onk(K) serta dokter spesialis paru konsultan onkologi toraks dr. Hasto Nugrogho Sp.P(K) Onk, FISR, MKM, perawat terlatih dan apoteker.</p><p>Dalam upaya penanganan kanker paru yang lebih optimal RSPAW juga menyediakan layanan Cryosurgery yang&nbsp;<strong>masih terbilang jarang di Indonesia. Cryosurgery merupakan pembedahan dengan memanfaatkan pembekuan&nbsp;untuk mematikan atau merusak sel kanker dengan&nbsp;menggunakan gas argon dan gas helium.&nbsp;Argon menciptakan suhu dingin&nbsp;hingga -120 derajat celcius untuk membunuh&nbsp;sel kanker, lalu helium menghangatkannya&nbsp;kembali. Dengan perubahan suhu seperti itu,&nbsp;sel kanker dapat hancur secara tuntas.&nbsp;Teknik ini dinilai cukup efektif untuk penanganan kanker paru karena hanya memerlukan waktu yang singkat,&nbsp;</strong>tanpa operasi terbuka, luka&nbsp;yang kecil dan hanya sedikit mengeluarkan&nbsp;darah. </p> `,
    author: "Humas RSPAW",
    date: new Date(),
    image: "-",
    type: "news",
