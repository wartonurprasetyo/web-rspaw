...
const EditSlider = () => {
    ...
    function saveSlider() {
        ...
        updateSlider(query).then((result) => {
    ...
    const getData = () => {
        ...
        getListSliderbyId(query).then((response: any) => {
            ...
            setImage(response.data.Data.data.slider_src)
                    ...
                    <Form>
                        ...
                        <Row>
                            <FormGroup>
                                ...
                                <Input type="file" o onChange={handleImagePreview} accept="image/*" ></Input>
